...
<head>
  ...
  <title>SLMS | Current Admins</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="#">users Available</a></li>
    ...
    <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <span style="font-size: 20px; margin-right: 10px;">User Listing</span>
              <a class="btn btn-primary btn-sm" href="add_user.php">Add Users</a><!-- Button trigger modal -->
...
<a data-toggle="tooltip" title="" class="btn btn-primary pull-right" style="margin-right: 5px" href="https://www.otsglobal.org/lms//panel/books/getBooks/xls" data-original-title="Export to Excel">
  <i class="fa fa-file-excel-o fa-2x"></i>
            ...
            <div class="box-body">
              ...
              <div id="PRData_wrapper" class="dataTables_wrapper form-inline dt-bootstrap"><div class="row"><div class="col-sm-6"><div class="dataTables_length" id="PRData_length"><label>Show <select name="PRData_length" aria-controls="PRData" class="form-control input-sm"><option value="10">10</option><option value="25">25</option><option value="50">50</option><option value="100">100</option><option value="-1">All</option></select> entries</label></div></div><div class="col-sm-6"><div id="PRData_filter" class="dataTables_filter"><label>Search:<input type="search" class="form-control input-sm" placeholder="" aria-controls="PRData"></label></div></div></div><div class="row"><div class="col-sm-12"><table id="PRData" style="width: 100%;" class="table table-bordered table-striped table-hover dataTable" role="grid" aria-describedby="PRData_info">
                ...
                <th class="sorting" rowspan="1" colspan="1"style="width: 200px;">Username</th>
                <th class="sorting" tabindex="0" aria-controls="PRData" rowspan="1" colspan="1" aria-label="user_type: activate to sort column ascending" style="width: 107px;">User Type</th>
                <th class="sorting" tabindex="0" aria-controls="PRData" rowspan="1" colspan="1" aria-label="qty: activate to sort column ascending" style="width: 200px;">Number Added</th>
                <th class="sorting" tabindex="0" aria-controls="PRData" rowspan="1" colspan="1" aria-label="email: activate to sort column ascending" style="width: 200px;">Email Adress</th>
                <th class="sorting" tabindex="0" aria-controls="PRData" rowspan="1" colspan="1" aria-label="phone: activate to sort column ascending" style="width: 200px;">Phone Number</th>
                <th class="sorting_disabled" rowspan="1" colspan="1" aria-label="Actions" style="width: 89px;">Actions</th></tr>
                </thead>
                <tbody>
                <?php 
                ...
                ?>
                <tr role="row" class="user_link" id="1800">
                  <td>
                  <img style="width:20px; height:30px;" src="https://www.otsglobal.org/lms/assets/uploads/user_image/user.png"></td>
                  <td><strong><?php echo $results['user'] ?></strong><br>
                      <strong>National ID:<?php echo $results['national'] ?> </strong><br></td>
                  <td><?php echo $results['user_type'] ?></td>
                 ...
                 <button class='btn po-close'>No</button>" rel="popover">
                  <i class="fa fa-trash-o"></i>
                    ...
                    </li><li></li><li><a href="https://www.otsglobal.org/lms/panel/users/edit/1800"><i class="fa fa-edit"></i>Edit Book</a></li><li><a href="https://www.otsglobal.org/lms/panel/users/print_barcodes/1800"><i class="fa fa-print"></i> Print Barcode</a>
                 </li></ul></div></div></td>
                 </tr>
                <?php } ?>
                <tfoot>
                ...
                <th rowspan="1" colspan="1">Number Added</th>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright <?php echo date('Y')?> <a href="http://smartsuperelec.co.ke">SLMS</a>.</strong> All rights
    reserved.
  </footer>
